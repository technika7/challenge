...
export default function Register() {
    ...
    const email = useRef()
    const eth_wallet_address = useRef()
    ...
    async function onSubmitForm(event) {
        ...
        const data = {
            ...
            eth_wallet_address: eth_wallet_address.current.value,
    ...
    return (
        <div className='container'>
            ...
            <form onSubmit={onSubmitForm}>
                ...
                <div className="mb-3">
                    <input type="eth_wallet_address" placeholder='Ethereum Wallet Address' autoComplete='off' className='form-control' id="eth_wallet_address" ref={eth_wallet_address} />
                </div>
                <div className="mb-3">
